      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <li class="nav-item dropdown">
              ...
              <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="clientes\customers\index.php" role="button" data-bs-toggle="" aria-expanded="false">
              <i class="fa-solid fa-eye"></i></i> Visualizar Clientes
              </a>
               </li>   
               <li class="nav-item dropdown">
